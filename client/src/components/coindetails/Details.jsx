...
const Details = (props) => {
    ...
    return (
        ...
        <ul className='coin-details'>
            ...
            <li>% CHANGE 1H:<div>{coinDetails.market_data.price_change_percentage_1h_in_currency.usd && 
                                  coinDetails.market_data.price_change_percentage_1h_in_currency.usd.toFixed(2) + '%'}
                            </div>
            </li>
